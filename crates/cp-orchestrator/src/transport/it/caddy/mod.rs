...
pub(crate) fn render_caddyfile(provisioned: bool, subjects: &[String]) -> String {
    ...
    out.push_str("# Generated by the Context Pilot orchestrator \u{2014} do not edit by hand.\n");
    ...
    if provisioned && !subjects.is_empty() {
        out.push_str("# Product cockpit \u{2014} private-CA TLS, served once provisioned.\n");
        out.push_str(&site_line(subjects, "https", None));
        out.push_str(" {\n\tbind 0.0.0.0 ::\n\ttls internal\n\treverse_proxy ");
        out.push_str(PRODUCT_UPSTREAM);
        out.push_str("\n}\n\n");

        out.push_str("# Plain HTTP \u{2192} HTTPS (only once provisioned \u{2014} no app on :80).\n");
        ...
        out.push_str("# Day-0 cockpit \u{2014} cleartext :80, ANY host (the ULA is the way in).\n");
