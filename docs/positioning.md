...
> **Objet :** fonder le discours de la landing (`docs/web/`) sur ce que le produit
> contient réellement, et sur ce que le marché contient réellement.
...
| Section actuelle | Verdict | Action |
|---|---|---|
