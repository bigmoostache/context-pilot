...
/**
 * shadcn-style Tooltip (mobile twin) built on Base UI's Tooltip primitive.
 *
 * A tooltip is a hover/focus affordance; on touch (no hover) it's largely inert,
 * so the wiring is unchanged from the desktop twin. The one mobile correctness
 * fix is the width clamp: `max-w-[calc(100vw-2rem)]` (vs the desktop `max-w-xs`
 * / 320px) so a longer tip can never be wider than a narrow phone and clip off
 * the screen edge.
 */
