  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center gap-2">
        <span className="rounded-md bg-[var(--ok)]/15 px-2 py-1 text-[11px] font-medium text-[var(--ok)]">
          ● Queue active
        </span>
      ...
      <div className="mt-4 flex gap-2">
        <button className="flex-1 rounded-md bg-[var(--signal)] px-3 py-1.5 text-[12px] font-medium text-[var(--primary-foreground)]">
