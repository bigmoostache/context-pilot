...
export const threads: Thread[] = [
  {
    ...
    messages: 8,
    unread: 1,
    last: "show me the meter, hide the carburetor.",
  },
  {
    id: "T4",
    name: "hello 4",
  ...
  },
  {
    ...
    messages: 12,
    unread: 0,
    last: "Deadman fix tagged and shipped.",
  },
]
...
export const spine: SpineNotif[] = [
  {
    ...
    kind: "custom",
    time: "17:24",
    text: "Please think more. Thinking is cheap and sharpens you.",
    processed: true,
  },
  {
    id: "N3404",
    kind: "user",
    time: "17:18",
    text: "which is the best long-run option?",
    processed: true,
  },
  {
    id: "N3402",
    kind: "user",
    time: "17:16",
    text: "Ok. the purpose of this branch is a frontend maquette…",
    processed: true,
  },
  {
    id: "N3400",
    kind: "user",
    time: "16:47",
    text: "clean your context entirely",
    processed: true,
  },
]
