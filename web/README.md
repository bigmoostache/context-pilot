...
| `CP_ORCH_BIND` | `127.0.0.1`             | Orchestrator listen address. Loopback by default (on the appliance Caddy is the only LAN-facing surface); set `0.0.0.0` to reach a dev backend from another machine |
