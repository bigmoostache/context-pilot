...
const KIND_BY_EXT: Record<string, FinderKind> = {
  rs: "code", py: "code", js: "code", ts: "code", tsx: "code", jsx: "code",
  go: "code", c: "code", cpp: "code", h: "code", hpp: "code", java: "code",
  rb: "code", sh: "code", bash: "code", zsh: "code", lua: "code", zig: "code",
  swift: "code", kt: "code", scala: "code", ex: "code", exs: "code", erl: "code",
  hs: "code", ml: "code", css: "code", scss: "code", html: "code", sql: "code",
  r: "code", pl: "code", php: "code", cs: "code", fs: "code", vue: "code",
  svelte: "code", dart: "code", nim: "code", v: "code", wasm: "code",
  md: "markdown", mdx: "markdown",
  json: "json", jsonl: "json", json5: "json",
  pdf: "pdf",
  png: "image", jpg: "image", jpeg: "image", gif: "image", svg: "image",
  webp: "image", bmp: "image", ico: "image", tiff: "image", heic: "image",
  csv: "sheet", xlsx: "sheet", xls: "sheet", ods: "sheet", tsv: "sheet",
  ...
  wmv: "video", flv: "video",
  txt: "doc", log: "doc", yml: "doc", yaml: "doc", toml: "doc", cfg: "doc",
  ini: "doc", env: "doc", conf: "doc",
}
